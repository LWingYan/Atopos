...
$(document).ready(function(){
        ...
        $("input[id*='keywords']").parent().parent().parent().hide();
        $("textarea[id*='description']").parent().parent().parent().hide();
        $("textarea[id*='thumb']").parent().parent().parent().hide();
        
        
        $("textarea[id*='CustomCSS']").parent().parent().parent().show();
        $("textarea[id*='CustomScript']").parent().parent().parent().show();
        
        $("input[id*='ggimg']").parent().parent().parent().hide();
        $("input[id*='gglinks']").parent().parent().parent().hide();
        
        

        if(s == 'article'){
            $("textarea[id*='description']").parent().parent().parent().show();
            $("textarea[id*='thumb']").parent().parent().parent().show();
            $("input[id*='keywords']").parent().parent().parent().show();
            $("textarea[id*='CustomCSS']").parent().parent().parent().show();
            $("textarea[id*='CustomScript']").parent().parent().parent().show();
        }

        if(s == 'gg'){
            $("input[id*='ggimg']").parent().parent().parent().show();
            $("input[id*='gglinks']").parent().parent().parent().show();
            
            $("textarea[id*='CustomCSS']").parent().parent().parent().hide();
            $("textarea[id*='CustomScript']").parent().parent().parent().hide();
        }
